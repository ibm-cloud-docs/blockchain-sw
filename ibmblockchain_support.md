...
For issues that are related to {{site.data.keyword.blockchainfull_notm}} Platform v2.1.2, you can submit a support case from the [mysupport](https://www.ibm.com/support/pages/node/1072956){: external} page.  
